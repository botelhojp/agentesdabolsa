...
window.ngGrid.i18n['pt'] = {
    ngAggregateLabel: 'itens',
    ngGroupPanelDescription: 'Arraste um cabeçalho de coluna aqui e solte-o para agrupar por essa coluna.',
    ngSearchPlaceHolder: 'Procurar...',
    ngMenuText: 'Escolha a coluna:',
    ngShowingItemsLabel: 'Mostrar Itens:',
    ngTotalItemsLabel: 'Total Itens:',
    ngSelectedItemsLabel: 'Itens selecionados:',
    ngPageSizeLabel: 'Itens por página:',
    ngPagerFirstTitle: 'Primeiro',
    ngPagerNextTitle: 'Próximo',
    ngPagerPrevTitle: 'Anterior',
    ngPagerLastTitle: 'Último'
};